...
class SampleSpider(scrapy.Spider):
    name = 'sample'
    addr= pd.read_csv(r'E:\scrapy\beginning\fortest\block.csv',encoding = "utf-8")
    ...
    def parse(self, response):
        ...
        yield infoDict
        if next_href != 'https://blockchain.info/block/0000000000510e5560b36ab97103bc43dbfb1f81074b7933e18933f6c635d860':
            H = 0
            while H != 100:
                try:
                    yield scrapy.Request(next_href, callback=self.parse)
