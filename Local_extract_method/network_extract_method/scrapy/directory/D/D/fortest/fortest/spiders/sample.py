...
class SampleSpider(scrapy.Spider):
    name = 'sample'
    addr= pd.read_csv(r'D:\fortest\block.csv',encoding = "utf-8")
    ...
    def parse(self, response):
        ...
        yield infoDict
        if next_href != 'https://blockchain.info/block/0000000000000000138e108e780fdb71eb4cad533b46445ab6befbf9687f561f':
            H = 0
            while H != 100:
                try:
                    yield scrapy.Request(next_href, callback=self.parse)
