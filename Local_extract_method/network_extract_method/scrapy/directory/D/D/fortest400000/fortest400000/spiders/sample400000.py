...
class Sample400000Spider(scrapy.Spider):
    name = 'sample400000'
    addr = pd.read_csv(r'D:\fortest400000\block400000.csv', encoding="utf-8")
    ...
    def parse(self, response):
        ...
        infoDict['Height'] = [int(
            ...
            SUM)
        yield infoDict
        if next_href != 'https://blockchain.info/block/000000000000000000ef751bbce8e744ad303c47ece06c8d863e4d417efc258c':
            H = 0
            while H != 100:
                try:
                    yield scrapy.Request(next_href, callback=self.parse)
