...
class Sample400000Spider(scrapy.Spider):
    name = 'sample400000'
    addr = pd.read_csv(r'E:\scrapy\fortest400000\block400000.csv', encoding="utf-8")
    ...
    def parse(self, response):
        ...
        yield infoDict
        if next_href != 'https://blockchain.info/block/000000000000000000de069137b17b8d5a3dfbd5b145b2dcfb203f15d0c4de90':
            H = 0
            while H != 100:
                try:
                    yield scrapy.Request(next_href, callback=self.parse)
