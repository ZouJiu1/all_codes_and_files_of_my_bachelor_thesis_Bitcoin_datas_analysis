...
class SampleSpider(scrapy.Spider):
    name = 'sample'
    addr= pd.read_csv(r'E:\scrapy\fortest\block.csv',encoding = "utf-8")
    ...
    def parse(self, response):
        ...
        yield infoDict
        if next_href != 'https://blockchain.info/block/000000000000000004ec466ce4732fe6f1ed1cddc2ed4b328fff5224276e3f6f':
            H = 0
            while H != 100:
                try:
                    yield scrapy.Request(next_href, callback=self.parse)
