...
class Sample400000Spider(scrapy.Spider):
    name = 'sample400000'
    addr = pd.read_csv(r'F:\fortest400000\block400000.csv', encoding="utf-8")
    ...
    def parse(self, response):
        ...
        yield infoDict
        if next_href != 'https://blockchain.info/block/00000000000000000024fb37364cbf81fd49cc2d51c09c75c35433c3a1945d04':
            H = 0
            while H != 100:
                try:
                    yield scrapy.Request(next_href, callback=self.parse)
